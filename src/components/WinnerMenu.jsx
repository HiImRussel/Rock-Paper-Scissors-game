...
import "../css/WinnerMenu.css";

const WinnerMenu = ({ userPick, computerPick, reset }) => {
  ...
  useEffect(() => {
    ...
    if (
      (userPick === "rock" && computerPick === "rock") ||
    ...
    <section id="winner-section">
      <div id="picked-items">
        <div className="picked-item">
          {<UserSvg />}
          <h5>You picked: {userPick}</h5>
        </div>
        <h4>VS</h4>
        <div className="picked-item">
          {<ComputerSvg />}
          <h5>Computer picked: {computerPick}</h5>
        </div>
      </div>
      {winner === "Draw" ? <h2>Draw!</h2> : <h2>Winner: {winner}!</h2>}
